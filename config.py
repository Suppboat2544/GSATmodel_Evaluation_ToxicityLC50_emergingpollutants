...
# Data paths
DATA_PATH = '/Users/suppboat/GSATmodel_Evaluation_ToxicityLC50_emergingpollutants/Copy of Merged_Norman-M_DS.csv'
...
CONFORMER_CONFIG = {
    'max_conf': 3,        # Reduced from 5 to 3 conformers
    'max_attempts': 10    # Reduced from 100 to 10 attempts (90% speedup!)
}
